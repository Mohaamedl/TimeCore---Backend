...
public class User implements Comparable<User> {
	...
	@Embedded
	@AttributeOverrides({
			@AttributeOverride(name = "enabled", column = @Column(name = "two_factor_auth_enabled", nullable = false)),
			@AttributeOverride(name = "send_to", column = @Column(name = "two_factor_auth_send_to"))
	})
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, user.id) && Objects.equals(fullname, user.fullname)
				...
				&& Objects.equals(mobile, user.mobile) && Objects.equals(twoFactorAuth, user.twoFactorAuth)
				&& role == user.role && Objects.equals(events, user.events);
	}
